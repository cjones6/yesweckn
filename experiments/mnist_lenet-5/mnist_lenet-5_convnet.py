"""
Train a LeNet-5 ConvNet on the MNIST dataset
"""
...
parser = argparse.ArgumentParser(description='LeNet-5 ConvNet training on the MNIST dataset')
...
parser.add_argument('--incomplete_scheme', default=0, type=int,
                    help='Whether to use the incomplete connection scheme from the original LeNet-5')
parser.add_argument('--lambda_filters', default=-7, type=int,
...
parser.add_argument('--save_path', default='../../results/mnist_lenet-5_convnet/', type=str,
...
model = lenet.LeNet5(nfilters=args.num_filters, locally_connected_layer=args.incomplete_scheme, bias=True)
